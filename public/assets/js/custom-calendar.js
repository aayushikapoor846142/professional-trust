(function(window) {
    ...
    CalendarWidget.initialize = function(elementId,param) {
        const selected_date = param.selectedDate !== undefined ? param.selectedDate:'';
        const days =  param.days !== undefined ? param.days:[];
        ...
        function buildCalendar(month, year) {
            ...
            for (let d = 1; d <= numDays; d++) {
                ...
                if (date < today) {
                    ...
                    cell.classList.add('disabled');
                }else if(disabledDates.includes(dateStr.toLowerCase())){
                    cell.classList.add('disabled');
                } else {
