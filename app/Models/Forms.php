...
class Forms extends Model
{
    ...
    protected $fillable = ['unique_id','name','form_type','fg_field_json','added_by'];
    ...
    public function serviceAssesmentForm(){
    	return $this->hasOne('App\Models\ServiceAssesmentForm', 'form_id');
    }

    public function sendForm(){
    	return $this->hasMany('App\Models\SendForms', 'form_id','id');
    }
}
