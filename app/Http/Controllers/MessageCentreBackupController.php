...
class MessageCentreController extends Controller
{
    ...
    public function overview()
    {
        ...
        return view("admin-panel.01-message-system.message-centre.conversations.chat.message-overview",$viewData);
    }
    ...
    public function searchUsers(Request $request){
        ...
        $contents = view("admin-panel.01-message-system.message-centre.conversations.chat.search-messages",$viewData)->render();
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            return view('admin-panel.01-message-system.message-centre.conversations.chat',$viewData);
        } catch (\Exception $e) {
            return redirect()->back()->with("error", "An error occurred: " . $e->getMessage());
        }
    }
    ...
    public function individualChatAjax($conversation_id,Request $request){
        ...
        if($viewData){
            $view = view("admin-panel.01-message-system.message-centre.conversations.chat.message-container",$viewData);
    ...
    public function conversationList(Request $request)
     {
            ...
            $viewData['chat_user_list'] = $chat_user_list;
             ...
             $view = View::make('admin-panel.01-message-system.message-centre.conversations.chat.chat_sidebar_ajax',$viewData);
             $contents = $view->render();
             $response['contents'] = $contents;
    ...
    public function chatRequests(Request $request){
        ...
        $contents = view("admin-panel.01-message-system.message-centre.conversations.chat.conversation-request-sidebar",$viewData)->render();
        $response['status'] = true;
    ...
    public function previewFile(Request $request){
        ...
        $view = view("admin-panel.01-message-system.message-centre.conversations.chat.preview-file",$viewData);
