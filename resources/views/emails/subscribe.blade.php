...
<table class="container_400" align="center" width="400" border="0" cellspacing="0" cellpadding="10"
    ...
    <tr>
        <td mc:edit="text003" class="text_color_282828"
            ...
            <div>
                <p>Hi {{$name}},</p>
                <p>Thank you for subscribing to our Notification & Alert System!</p>
                <p>You'll now receive real-time alerts and updates, ensuring that you're always informed about important events and notifications.</p>
                <p>We appreciate your trust in us and are excited to keep you updated.</p>
                <p>Thank you!</p>
            </div>
        </td>
    </tr>
