...
<div class="container">
    <section class="cdsTYDashboard-amount-contributed">
        <div class="cdsTYDashboard-amount-contributed-container">
            <div class="cdsTYDashboard-amount-contributed-container-body">
                @if ($record)
                <div class="cdsTYDashboard-amount-contributed-container-body-list">
                    <div class="cdsTYDashboard-amount-contributed-container-body-list-inner">
                        ...
                        @if ($record->subscription_data) @php $subscription = json_decode($record->subscription_data, true); @endphp @if ($subscription)
                        ...
                        <div class="cdsTYDashboard-amount-contributed-container-body-list-segment">
                            ...
                            <div class="cdsTYDashboard-amount-contributed-container-body-list-segment-body">
                                <div class="cdsTYDashboard-amount-contributed-container-body-list-segment-row">
                                    ...
                                    <div class="cdsTYDashboard-amount-contributed-container-body-list-segment-cells"><span>Country: </span>{{ $subscription['country'] ?? 'N/A' }}</div>
                                    <div class="cdsTYDashboard-amount-contributed-container-body-list-segment-cells">
                                        <span>Zip Code:</span>
                                        {{ $subscription['zip'] ?? 'N/A' }}
                                    </div>
                        ...
                        <div class="cdsTYDashboard-amount-contributed-container-body-list-segment">
                            ...
                            <div class="cdsTYDashboard-amount-contributed-container-body-list-segment-body">
                                <div class="cdsTYDashboard-amount-contributed-container-body-list-segment-row">
                                    ...
                                    <div class="cdsTYDashboard-amount-contributed-container-body-list-segment-cells"></div>
                                    <div class="cdsTYDashboard-amount-contributed-container-body-list-segment-cells">
            ...
            <div class="cdsTYDashboard-amount-contributed-container-footer"></div>
        </div>
    </section>  
</div>
@endsection