 ...
 <div class="cdsTYDashboard-amount-contributed-container-body">
    <div class="cds-t25n-content-professional-profile-container-main-navigation">
        <ul class="monthly-tabs">
            <li class="cds-active">
                <a href="javascript:;" class="monthly-tab-link cds-active" data-tab="monthly-overview">Overview</a>
            </li>
            <li>
                <a href="javascript:;" class="monthly-tab-link" data-tab="upcoming-invoices">Upcoming Invoices</a>
            </li>
            <li>
                <a href="javascript:;" class="monthly-tab-link" data-tab="subscription-history">Subscription History</a>
            </li>
             <li>
                <a href="javascript:;" class="monthly-tab-link" data-tab="basic-details">Basic Details</a>
            </li>
        </ul>
    </div>
    <div id="monthly-overview" class="monthly-tab-content">
        <div class="cdsTYSupportDashboard-amount-contributed-container-body-list">
            <div class="cdsTYSupportDashboard-amount-contributed-container-body-list-segment cds-ty-dashboard-segments">
                <div class="cdsTYSupportDashboard-amount-contributed-container-body-list-segment-header"> 
    ...
    <div id="upcoming-invoices" class="monthly-tab-content d-none">
    ...
    <div id="subscription-history" class="monthly-tab-content d-none">
        <div class="cdsTYSupportDashboard-amount-contributed-container-body-list-segment">
            <div class="cds-ty-dashboard-segments">
    ...
    <div id="basic-details" class="monthly-tab-content d-none">
       ...
       <script>
          $(document).ready(function() {
            $('.monthly-tab-link').on('click', function(e) {
                e.preventDefault();
            
                $('.monthly-tabs li').removeClass('cds-active');

                $('.monthly-tab-content').addClass('d-none');
            ...
            $('.closeMonthlySlideBtn').on('click', function () {
                $('.monthlySlideView').removeClass('active');
            });
        });
       </script>
