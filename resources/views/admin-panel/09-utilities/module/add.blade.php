...
<div class="container-fluid">
 ...
 <form id="form" class="js-validate mt-3" action="{{ baseUrl('module/save') }}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-xl-6 col-md-6 col-lg-6 mb-2">
                            {!! FormHelper::formInputText(['name'=>"name","id" => "name","label"=>"Enter name","required"=>true,'events'=>['oninput=validateName(this)']]) !!}
