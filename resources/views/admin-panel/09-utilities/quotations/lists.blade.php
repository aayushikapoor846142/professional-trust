...
@section('content')
 <div class="ch-action">
                  <a href="{{ baseUrl('quotations/add') }}" class="CdsTYButton-btn-primary">
 ...
 <form id="search-form">
                            ...
                            </form> <div class="cds-form-container search-area">
                        <div class="cds-action-elements">                    
                            <span class="font-size-sm mr-3">
                            <span id="datatableCounter">0</span>
                            Selected
                            </span>
                            <a class="CdsTYButton-btn-primary CdsTYButton-border-thick btn-multi-delete ml-2" data-href="{{ baseUrl('quotations/delete-multiple') }}"
                    ...
                    <div class="cdsTYDashboard-table">
                        <div class="cdsTYDashboard-table-wrapper">
                            <div class="cdsTYDashboard-table-header">
                                ...
                                <div class="cdsTYDashboard-table-cell sorted-asc" onclick="sortTable(1)">Quotation Title <span class="sort-arrow"></span></div>
                                <div class="cdsTYDashboard-table-cell" onclick="sortTable(2)">Service <span class="sort-arrow"></span></div>
...
<script type="text/javascript">
  ...
  function loadData(page = 1) {
    ...
    $.ajax({
      type: "POST",
      url: BASEURL + '/quotations/ajax-list?page=' + page,
