...
<div class="container">
    <div class="cds-ty-dashboard-box">
        ...
        <div class="cds-ty-dashboard-box-body">
            <div class="cds-invoices cdsTYDashboard-create-invoice">
                <form id="form" class="js-validate mt-3" action="{{ baseUrl('invoices/save') }}" method="post">
                    @csrf
                    <div class="cdsTYDashboard-create-invoice-container">
					 <div class="cdsTYDashboard-create-invoice-container-header">
                        ...
                        <div class="col-xl-6">
						 ...
						 <div class="cdsTYDashboard-create-invoice-container-body">
