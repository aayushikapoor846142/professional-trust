...
@section('content')
 <div class="ch-action">
                    <a href="{{baseUrl('manage-services/generate-assessments/'.$id)}}" class="CdsTYButton-btn-primary">
                        <i class="fa-plus fa-solid me-1"></i>
                        Add New
                    </a>
                    <a href="{{baseUrl('manage-services')}}" class="CdsTYButton-btn-primary">
                        ...
                        <div class="cdsTYDashboard-table">
                            <div class="cdsTYDashboard-table-wrapper">
                                <div class="cdsTYDashboard-table-header">
                                    <div class="cdsTYDashboard-table-cell sorted-asc" onclick="sortTable(0)">Name <span class="sort-arrow"></span></div>
                                    <div class="cdsTYDashboard-table-cell" onclick="sortTable(1)">Type <span class="sort-arrow"></span></div>
...
<script type="text/javascript">
  ...
  function loadData(page = 1) {
    ...
    $.ajax({
      type: "POST",
      url: BASEURL + '/manage-services/assesment-ajax-list?page=' + page,
      data: {
        _token: csrf_token,
        id: "{{$id}}"
      },
