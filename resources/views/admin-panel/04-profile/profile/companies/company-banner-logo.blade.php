        ...
        if (cropper) {
            ...
            originalCanvas.toBlob(
                (blob) => {
                    ...
                    $.ajax({
                        url: '{{ baseUrl("/companies/upload-company-banner-image/".$id) }}',
                        method: 'POST',
                        headers: {
                        ...
                        success: function (response) {
                            if (response.status) {
                                ...
                                $('#company-banner').css('background-image', 'url(' + response.filepath + ')');
                                $('#company-banner').attr('data-bg', response.filepath);
