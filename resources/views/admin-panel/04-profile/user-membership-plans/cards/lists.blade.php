...
@section('content')
 <div class="ch-action">
                    <a href="{{ baseUrl('my-membership-plans/add-card/'.$record->unique_id) }}" class="CdsTYButton-btn-primary">
                    ...
                    <div class="cdsTYDashboard-table">
                        <div class="cdsTYDashboard-table-wrapper">
                            <div class="cdsTYDashboard-table-header">
                                <div class="cdsTYDashboard-table-cell sorted-asc" onclick="sortTable(0)">Name on Card <span class="sort-arrow"></span></div>
                                <div class="cdsTYDashboard-table-cell" onclick="sortTable(1)">Last 4 Digits <span class="sort-arrow"></span></div>
                                <div class="cdsTYDashboard-table-cell" onclick="sortTable(2)">Default <span class="sort-arrow"></span></div>
...
<script type="text/javascript">
  ...
  function loadData(page = 1) {
    ...
    $.ajax({
      type: "POST",
      url: BASEURL + '/my-membership-plans/cards-ajax-list',
      data: {
        _token: csrf_token,
        search: search
      },
