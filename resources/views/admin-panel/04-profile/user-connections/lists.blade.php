                        ...
                        <div class="cdsTYDashboard-table">
                            <div class="cdsTYDashboard-table-wrapper">
                                <div class="cdsTYDashboard-table-header">
                                    ...
                                    <div class="cdsTYDashboard-table-cell sorted-asc" onclick="sortTable(1)">Email <span class="sort-arrow"></span></div>
                                    <div class="cdsTYDashboard-table-cell sorted-asc" onclick="sortTable(2)">Role <span class="sort-arrow"></span></div>
                                </div>
...
<script type="text/javascript">
  ...
  function loadData(page = 1,search = "") {
    ...
    $.ajax({
      type: "POST",
      url: BASEURL + '/settings/connections/ajax-list?page=' + page,
      data: {
        _token: csrf_token,
        search: search
      },
