...
<div class="CDSDashboardContainer-container" id="CDSDashboardContainer-dashboardContainer">
 ...
 @if(!empty($privacySettings))
                    <form id="form" class="js-validate" action="{{ baseUrl('/settings/account/update') }}" method="post">
                        @csrf
                                ...
                                @if($privacySettings->isNotEmpty())
                                    @foreach($privacySettings as $key => $settings)
                                        ...
                                        @if($settings->filed_type == "radio")
                                            <input type="hidden" name="settings[{{ $key }}][type]" value="radio">
                                        ...
                                        @if($settings->filed_type == "select")
                                            <input type="hidden" name="settings[{{ $key }}][type]" value="select">
                                        ...
                                        @if($settings->filed_type == "checkbox")
                                            <input type="hidden" name="settings[{{ $key }}][type]" value="checkbox">
                                            <div class="cds-account-settings-checkbox">
