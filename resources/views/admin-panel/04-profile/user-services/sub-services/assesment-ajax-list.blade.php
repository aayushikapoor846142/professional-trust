    ...
    <div class="cdsTYDashboard-table-cell" data-label="Action">
        <div class="btn-group">
            ...
            <ul class="dropdown-menu" aria-labelledby="defaultDropdown">
                <li>
                    <a class="dropdown-item" href="{{ baseUrl('my-services/view-assesment/'.$record->unique_id) }}">
                         View
                    </a>
                </li>
                <li>
                    <a class="dropdown-item" onclick="showPopup('{{ baseUrl('my-services/send-assesment-form/'.$record->unique_id) }}')"  href="javascript:;">
                        Send Form
                    </a>
                </li>
                <li>
                    <a class="dropdown-item"  href="{{ baseUrl('my-services/send-assesment-form-list/'.$record->unique_id) }}">
                        Send Form List
                    </a>
                </li>
            </ul>
