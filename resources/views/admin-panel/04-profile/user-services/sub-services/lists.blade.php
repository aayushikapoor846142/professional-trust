...
@section('content')
 <div class="ch-action">
                   @if(checkPrivilege([
                    ...
                    <a href="{{ baseUrl('my-services/add-sub-services/'.$id) }}" class="CdsTYButton-btn-primary">
                        Add New
                    </a>
                    @endif
 ...
 <form id="search-form">
                        ...
                        <div class="cdsTYDashboard-table">
                            <div class="cdsTYDashboard-table-wrapper">
                                <div class="cdsTYDashboard-table-header">
                                    ...
                                    <div class="cdsTYDashboard-table-cell sorted-asc" onclick="sortTable(1)">Form <span class="sort-arrow"></span></div>
                                    <div class="cdsTYDashboard-table-cell" onclick="sortTable(2)">Sub Service Types <span class="sort-arrow"></span></div>
                                    <div class="cdsTYDashboard-table-cell" onclick="sortTable(3)">Professional Fees <span class="sort-arrow"></span></div>
                                    <div class="cdsTYDashboard-table-cell" onclick="sortTable(4)">Consultancy Fees <span class="sort-arrow"></span></div>
  ...
  <script type="text/javascript">
    ...
    function loadData(page = 1) {
      ...
      $.ajax({
        type: "POST",
        url: BASEURL + '/my-services/ajax-sub-services?page=' + page,
        data: {
          _token: csrf_token,
          search: search,
          id:"{{$id}}",
