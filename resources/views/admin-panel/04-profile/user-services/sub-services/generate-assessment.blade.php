...
@section('content')
 <div class="ch-action">
                    <a href="{{ baseUrl('my-services/list-assessment/'.$record->unique_id) }}" class="CdsTYButton-btn-primary">
    ...
    <form id="popupForm" action="{{ baseUrl('/my-services/generate-assessment/'.$record->unique_id) }}" method="post" enctype="multipart/form-data" class="question-form">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="" class="col-form-label input-label my-2">Form Type</label>
                                ...
                                <div class="col-md-12 mt-3">
                                    <label class="col-form-label input-label my-2">Form will be generate for  {{ $record->subServices->parentService->name??'' }} > {{ $record->subServices->name??'' }}</label>
