                ...
                <div class="CdsTYDashboard-special-filters-dropdown-container">
                    <div class="CdsTYDashboard-special-filters-buttons-row">
                        ...
                        <div class="cdsTYDashboardDropdownsDropdown">
                            <button class="cdsTYDashboardDropdownsDropdownBtn" data-original-text="Feed Post By">Feed Post By</button>
                            <div class="cdsTYDashboardDropdownsDropdownMenu">
                                ...
                                <div class="cdsTYDashboardDropdownsDropdownItem" data-value="professional">
                                    <span class="cdsTYDashboardDropdownsDropdownItemIcon">👤</span>
                                    By Professional
                                </div>
                                <div class="cdsTYDashboardDropdownsDropdownItem" data-value="associate">
                                    <span class="cdsTYDashboardDropdownsDropdownItemIcon">👤</span>
                                    By Associate
                                </div>
                            </div>
