...
@if(checkPrivilege([
                    ...
                    @php
                    $canViewAppointmentBookingFlow=true;
                    @endphp
@else
                    @php
                    $canViewAppointmentBookingFlow=false;
                    @endphp
@endif
@if(checkPrivilege([
                        'route_prefix' => 'panel.appointment-booking-flow',
...
@if(checkPrivilege([
                    ...
                    @php
                    $canDeleteAppointmentBookingFlow=true;
                    @endphp
@else
                    @php
                    $canDeleteAppointmentBookingFlow=false;
                    @endphp
@endif
@php 
$page_arr = [
    'page_title' => 'Appointment Booking Flow ',
    'page_description' => 'Manage appointment booking flow.',
    'page_type' => 'appointment-booking-flow',
    'canViewAppointmentBookingFlow' => $canViewAppointmentBookingFlow,
    'canAddAppointmentBookingFlow' => $canAddAppointmentBookingFlow,
    'canDeleteAppointmentBookingFlow' => $canDeleteAppointmentBookingFlow,
        ...
        <div class="CDSDashboardContainer-main-content-inner">  
			 <div class="CDSDashboardContainer-main-content-inner-header">
                @if(isset($appointmentBookingFlowFeatureStatus))
                    @if(!$canViewAppointmentBookingFlow)
                ...
                <form id="search-form">
                            ...
                            @if($canDeleteAppointmentBookingFlow)
                             <div class="cds-action-elements">
                                <span class="font-size-sm mr-3">
                                    <span id="datatableCounter">0</span>
                                    Selected
                                </span>
                               <a class="CdsTYButton-btn-primary CdsTYButton-border-thick btn-multi-delete ml-2" data-href="{{ baseUrl('appointments/appointment-booking-flow/delete-multiple') }}" onclick="deleteMultiple(this)" href="javascript:;">
			 ...
			 <div class="CDSDashboardContainer-main-content-inner-body">
                        ...
                        <div class="cdsTYDashboard-table">
                            <div class="cdsTYDashboard-table-wrapper">
                                <div class="cdsTYDashboard-table-header">
                                    ...
                                    <div class="cdsTYDashboard-table-cell sorted-asc" data-column="title" data-order="asc" onclick="sortTable(this)">Title <span class="sort-arrow"></span></div>
                                    <div class="cdsTYDashboard-table-cell sorted-asc">Time Duration </div>
                                    <div class="cdsTYDashboard-table-cell sorted-asc" >Appointment Type</div>
                                    <div class="cdsTYDashboard-table-cell sorted-asc" >Working Hours</div>
                                    <div class="cdsTYDashboard-table-cell sorted-asc">Timezone </div>
                                    <div class="cdsTYDashboard-table-cell sorted-asc" data-column="appointment_mode" data-order="asc" onclick="sortTable(this)">Appointment Mode <span class="sort-arrow"></span></div>
                ...
                @else
                    <div class="text-center text-muted">
                        <p>You don't have permission to view appointment booking flow.</p>
                    </div>
                @endif
...
<script type="text/javascript">
const cookiePrefix = 'appointment_booking_'; 
...
function getCookie(name) {
  ...
  function loadData(page = 1) {
    ...
    $.ajax({
      type: "POST",
      url: BASEURL + '/appointments/appointment-booking-flow/ajax-list?page=' + page,
      data: {
        _token: csrf_token,
        search: search,
