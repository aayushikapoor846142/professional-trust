                    ...
                    @if($attachment)
                        ...
                        <div class="shared-file-item" data-file-name="{{ $attachment }}" data-file-type="{{ $fileExtension }}">
                            <div class="file-preview">
                                @if($isImage)
                                    <div class="file-preview-image">
                                        <img src="{{ chatDirUrl($attachment, 's') }}" 
                                             alt="{{ $fileName }}" 
                                             class="file-thumbnail"
                                             onclick="previewFile('{{ baseUrl('individual-chats/preview-file?file_name='.$attachment.'&chat_id='.$getAttachment->unique_id) }}')" />
                                        <div class="file-overlay">
                                            <button class="btn-preview" onclick="previewFile('{{ baseUrl('individual-chats/preview-file?file_name='.$attachment.'&chat_id='.$getAttachment->unique_id) }}')">
                            ...
                            <div class="file-actions">
                                <button class="btn-download" onclick="downloadFile('{{ baseUrl('individual-chats/download-file?file_name='.$attachment.'&chat_id='.$getAttachment->unique_id) }}')" title="Download">
                                    <i class="fas fa-download"></i>
                                </button>
