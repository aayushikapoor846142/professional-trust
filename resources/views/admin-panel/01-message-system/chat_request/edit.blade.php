...
<div class="CDSDashboardContainer-container" id="CDSDashboardContainer-dashboardContainer">
   ...
   <form id="form" class="js-validate mt-3" action="{{ baseUrl('/company-locations/update/'.$record->unique_id) }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="js-form-message">
                                        <input type="text" class="form-control google-address" name="address_1"
                                            ...
                                            data-msg="" value="{{$record->address_1}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="js-form-message">
                                        <input type="text" class="form-control" name="address_2"
                                            ...
                                            data-msg="" value="{{$record->address_2}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="js-form-message">
                                        <select class="form-control" name="country" id="country">
                                            ...
                                            <option value="{{ $country->name }}" {{$record->country == $country->name ? 'selected' : ''}}>{{ $country->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="js-form-message">
                                        <input type="text" class="form-control required" name="state"
                                            ...
                                            data-msg="" value="{{$record->state}}" oninput="validateName(this)">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="js-form-message">
                                        <input type="text" class="form-control required" name="city"
                                            ...
                                            data-msg="" value="{{$record->city}}" oninput="validateName(this)">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="js-form-message">
                                        <input type="text" class="form-control required" name="pincode"
                                            ...
                                            data-msg="" value="{{$record->pincode}}" oninput="validateDigit(this)">
                                    </div>
                                </div>
                            </div>
                        </div>
