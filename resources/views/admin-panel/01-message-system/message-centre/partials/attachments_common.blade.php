...
<div class="attachment" data-file-name="{{ $attachment }}">
    <a href="javascript:;"
        onclick="showPopup('<?php echo baseUrl('message-centre/preview-file?file_name='.$attachment.'&chat_id='.$chat_msg_Unique_id) ?>')"
...
<div class="attachment" data-file-name="{{ $attachment }}">
    ...
    @endphp
    <a href="javascript:;"
        onclick="showPopup('<?php echo baseUrl('message-centre/preview-file?file_name='.$attachment) ?>')"
        class="popup-link" title="{{$attachment}}">
        <div class="cds-smalIcons">
