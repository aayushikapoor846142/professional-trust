...
<div class="ch-head">
          ...
          <div class="ch-action">
              <a href="{{ baseUrl('chat-groups') }}" class="CdsTYButton-btn-primary">
                  Back
              </a>
          </div>
  ...
  <form id="form" class="js-validate" action="{{ baseUrl('create-group') }}" method="post">
            @csrf
            <div class="row">
                <div class="col-md-6">
                      {!! FormHelper::formInputText(['name'=>"name","label"=>" Name","required"=>true, 'events' => [
