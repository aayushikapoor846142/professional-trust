                    ...
                    <div id="filesContent" class="accordion-collapse collapse show" aria-labelledby="filesHeader"
                        ...
                        <div class="accordion-body p-0">
                            ...
                            <div id="attachments-container">
                                @include('admin-panel.01-message-system.group-messages.components.files.shared-files',['files'=>$groupAttachments])
                            </div>
                            @if(!empty($groupAttachments) && $groupAttachments->hasMorePages())
                            <button id="load-more" class="btn btn-primary load-more-btn"
