...
<div id="stats-container">
 ...
 <div class="CdsSendInvitation-list-card cdsfeedoverflow">
                <div class="cds-ty-dashboard-box-header CdsSendInvitation-list-header">
                    <div class="CdsSendInvitation-list-title-section">
                        <h2 class="CdsSendInvitation-list-title">Review Received History</h2>
                    ...
                    <div class="cds-action-elements" style="display: none;">
                        ...
                        <a class="CdsTYButton-btn-primary CdsTYButton-border-thick" data-href="{{ baseUrl('reviews/review-received/delete-multiple') }}" onclick="deleteMultiple(this)" href="javascript:;">
                            Delete
                        </a>
                    </div>
                ...
                @include("admin-panel.07-invitations.reviews.components.header-search")
...
function loadData(page = 1) {
    ...
    const reviewGiven = params.get("review_given");
    $.ajax({
        type: "POST",
        url: BASEURL + '/reviews/review-received/ajax-list?page=' + page,
        data: {
            _token: csrf_token,
            search: search,
            status: status,
