        ...
        <div class="d-flex gap-2">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                           ...
                           <li>
                                <a href="javascript:;" onclick="showPopup('<?php echo baseUrl('reviews/spam-reviews/report-spam-review/' . $record->unique_id) ?>')" >
                    ...
                    @if(checkPrivilege([
                        ...
                        <li>
                            ...
                            data-href="{{ baseUrl('reviews/spam-reviews/delete/' . $record->unique_id) }}">
                ...
                <div class="CdsSendInvitation-review-section">
                    ...
                    <div class="CdsSendInvitation-review-text">
                        ...
                        <div class="mt-2">
                            ...
                            @endif
                            <a class="btn btnRemove ms-md-2" href="{{ baseUrl('/reviews/spam-reviews/delete-review-reply/' . $check_reply->unique_id) }}"> <i class="fa-light fa-trash fa-sm"></i> Delete Reply </a>
                        </div>

                        {{-- Edit Form --}}
                        <form style="display: none;" id="editForm{{ $check_reply->id }}" action="{{ baseUrl('/reviews/spam-reviews/update-review-reply/' . $check_reply->unique_id) }}" method="post">
                            @csrf
                        ...
                        <form action="{{ baseUrl('reviews/spam-reviews/send-review-reply/' . $record->unique_id) }}" method="post">
                            @csrf
                            <div class="client-comment row mt-2">
                                <div class="col-sm-8">
