<div class="modal-dialog modal-dialog-centered modal-xl"> 
    <div class="modal-content">
          <form id="discussion-comment-form" enctype="multipart/form-data" action="{{ baseUrl('manage-discussion-threads/save-flag-comment') }}" method="post">
        ...
        <div class="modal-body">
                ...
                @csrf
                <input type="hidden" name="comment_id" value="{{ $discussioncomment->unique_id }}">
...
<script>
    $(document).ready(function() {
        ...
        $("#discussion-comment-form").submit(function(e) {
            e.preventDefault();
            var is_valid = formValidation("discussion-comment-form");
            if (!is_valid) {
                return false;
            }
           
            var formData = new FormData($(this)[0]);
            var url = $("#discussion-comment-form").attr('action');
            $.ajax({
                url: url,
                type: "post",
                data: formData,
