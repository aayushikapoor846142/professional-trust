...
<div class="cdsTYDashboard-table-row">
    ...
    <div class="cdsTYDashboard-table-cell" data-label="Added by">{{$record->userAdded->first_name}} {{$record->userAdded->last_name}}</div>
    ...
    <div class="cdsTYDashboard-table-cell" data-label="Action">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu" aria-labelledby="defaultDropdown">
                ...
                <li>
                    <a class="dropdown-item" href="{{ baseUrl('predefined-case-stages/edit/'.$record->unique_id) }}">
                ...
                <li>
                    <a class="dropdown-item" href="{{ baseUrl('predefined-case-stages/view/'.$record->unique_id) }}">
                ...
                <li>
                    <a class="dropdown-item text-danger" href="javascript:;" onclick="confirmAction(this)"
                        data-href="{{ baseUrl('predefined-case-stages/delete/'.$record->unique_id) }}">
                         Delete
                    </a>
                </li>
                @endif
