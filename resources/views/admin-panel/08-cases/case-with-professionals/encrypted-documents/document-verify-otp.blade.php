<div class="modal-dialog cdsTYDashboard-chat-group-full-stretched full-width-modal-content">
                ...
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                ...
                                <div class="cdsTYMainsite-login-form-container-body">
                                    <form method="post" id="otp-form" class="validate text-left">
                                        ...
                                        <input type ="hidden" name="case_encrypted_id" value="{{ $encryptedDocument->id }}">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-12 d-flex gap-2 justify-content-center mt-3">
                                                <a href="{{ url('registration/associate')  }}" class="CdsTYButton-btn-primary previous d-inline-block"> Back </a>
