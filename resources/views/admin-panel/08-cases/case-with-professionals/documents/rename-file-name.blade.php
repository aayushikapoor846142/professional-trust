<div class="modal-dialog modal-xl">
    <div class="modal-content">
        <form id="update-file-name" enctype="multipart/form-data"
            action="{{ baseUrl('case-with-professionals/rename-document/' . $record->unique_id) }}" method="POST">
            ...
            <div class="modal-body">
                @csrf
                <div class="cdsTYDashboard-chat-group-section d-block">
                    <div class="cdsTYDashboard-chat-group-section-main-panel">
                        <div class="chatgroup-name-block">
                         
                            <div>
                                {!! FormHelper::formInputText(['name'=>"name","id" => "name","label"=>"Enter New Name","required"=>true,'events'=>['oninput=replaceSpacewithDash(this)', 'onblur=replaceSpacewithDash(this)']]) !!}
