...
<div class="submit-bid p-3 border rounded bg-light">
    <h5>Send Request</h5>
    <form id="form" class="js-validate mt-3" action="{{ baseUrl('/case-with-professionals/save-request') }}" method="POST">
        @csrf
        ...
        <div class="row">
            ...
            <div class="mb-2 col-md-12 information-request-div" style="display:none;">
                ...
                {!! FormHelper::formTextarea(['name'=>"information",
                    'id'=>"information",
                    'required'=>false,
                    'class'=>"cds-texteditor",
                    'textarea_class'=>"",
                    'value' => html_entity_decode($record->comments->comments ?? '') 
                ]) !!}
               
            </div>
            <div class="mb-2 col-md-12">
                <label class="col-form-label input-label">Enter Message <span class="danger">*</span></label>
                {!! FormHelper::formTextarea(['name'=>"message_body",
                'id'=>"message_body",
                'required'=>true,
                'class'=>"cds-texteditor",
                'textarea_class'=>"",
...
<script>
    ...
    $(document).ready(function() {
        ...
        // removeFile function is already global
        ...
        $("#form").submit(function(e) {
            ...
            if (selectedFiles.length > 0) {
                ...
                console.log('No files selected, submitting form directly...');
                submitForm();
            }
        });
    });
