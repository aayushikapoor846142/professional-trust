    ...
    <div class="wizard">
        ...
        <div class="tab-content support-tab-content" id="myTabContent">
            <div class="tab-pane fade show active border-bottom-0" role="tabpanel" id="step1" aria-labelledby="step1-tab">
                <div class="cds-t35-content-support-form-segments card-detail inner-data mb-0">
                    ...
                    <div class="cds-t35-content-support-form-segments-body">
                        <div class="cdsTYMainsite-support-progress-indicator">
                        </div>
                        ...
                        <div class="cds-t35-content-support-form-segments-body-amount-list-wrap">
                            ...
                            <div class="cds-t35-content-support-form-segments-body-amount-list js-form-message">
                                ...
                                <label for="amount{{round($amount)}}" class="donation-label">${{round($amount)}}</label>
                            </div>
                            @endforeach
                        </div>
                        <div class="cds-t35-content-support-form-segments-body-other-amount-list-wrap">
                            ...
                            <div class="cds-t35-content-support-form-segments-body-other-amount-list-wrap-list cds-enteramount">
                                ...
                                {{--<div id="customAmountGroup">
                                    <span class="support-currency-symbol">$</span>
                                    <input type="text" class="form-control" id="customAmount" placeholder="Amount" name="custom_amount" min="20" max="10000" oninput="validateSupportAmount(this)">
                                    <span class="support-currency-type">CAD</span>
                                </div>--}}
                            </div>
                        </div>
                        <div class="alert alert-info text-center">Minimum amount: <b>$20</b> </div>
...
<script>
    ...
    async function submitPayment() {
        ...
        showPopup("<?php echo baseUrl('processing-payment') ?>");
        $.ajax({
            url: url,
            type: "POST",
            data: formData,
    ...
    function completePaymentAction(payment_intent_id,new_user){
        ...
        $.ajax({
            url: "{{ baseUrl('payment-methods/stripe/complete-payment') }}",
            type: "POST",
            data: formData,
            cache: false,
            contentType: false,
