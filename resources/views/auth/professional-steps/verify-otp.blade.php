...
<div class="cdsTYMainsite-login-form-container-body">
    <form method="post" id="otp-form" class="validate text-left">
        ...
        <div class="row mb-3">
            ...
            <button type="button" onclick="submitForm(this,'Resent Otp')" style="color:#063084;" class="btn r-04 btn--tra-black hover--theme last-link ml-10" id="resendOtpButton">Resend Otp</button>
            ...
            <div class="col-md-12 text-center mt-3">     
                <a href="{{ url('registration/professional')  }}" class="CdsTYButton-btn-primary"> Back </a>
                                       
                <button type="button" class="CdsTYButton-btn-primary" onclick="verifyOtp(this)">
                    Verify
                </button>
            </div>
        </div>
